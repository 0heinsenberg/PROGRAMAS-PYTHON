# -*- coding: utf-8 -*-
"""
Created on Tue Aug 12 14:30:10 2014
...
def ImportS2P(file_name, Cols=(0, 3, 4), Skip_head = 10, Delimiter = " "):
    ...
    """
    data = genfromtxt(file_name, delimiter=(
        Delimiter), skip_header=Skip_head, usecols=(Cols[0], Cols[1], Cols[2]))
    freq = data[:, 0]
    S21_Amp = data[:, 1]
    S21_Phase = data[:, 2]
    return freq, S21_Amp, S21_Phase

#______________________________________________________________

# Program to get file path using GUI dialog box

def ImportS3P(file_name, Cols=(0, 3), Skip_head = 0, Delimiter = " "):
    """  Import from s2p file freq, S21 - Amp and Phase, Return Freq, S21_Amp and S21
         sometimes need to use 
         np.genfromtxt(path, delimiter=("\t"), skip_header=5, usecols=(0,3,4),dtype=None)#,invalid_raise = False)
    """
...
def ImportS4P(file_name, Cols=(0, 3), Skip_head = 2, Delimiter = " "):
    """  Import from s2p file freq, S21 - Amp and Phase, Return Freq, S21_Amp and S21
         sometimes need to use 
         np.genfromtxt(path, delimiter=("\t"), skip_header=5, usecols=(0,3,4),dtype=None)#,invalid_raise = False)
    """
